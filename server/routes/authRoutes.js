...
const { registerUser, verifiedRegisterUser, createAccountForEmailVerifiedUser, loginUser, getUserProfileData } = require("../controllers/authController");
...
router.route("/profile/:id").get(isUserLoggedInProd, isUserCustomerProd, getUserProfileData);
